...
export default defineConfig([
  {
    name: 'india',
    title: 'India Site CMS',
    projectId: 'cvwqqd27',
    dataset: 'production',
    basePath: '/studio/india',
    plugins: [
      structureTool({
        structure: (S) =>
          S.list()
            ...
            .items([
              ...
              S.divider(),
              // ... keep all existing items for India
              S.listItem()
  ...
  {
    name: 'global',
    title: 'Global Site CMS',
    projectId: 'cvwqqd27',
    dataset: 'production',
    basePath: '/studio/global',
    plugins: [
      structureTool({
        structure: (S) =>
          S.list()
            ...
            .items([
              S.listItem()
                ...
                .child(S.documentTypeList('globalPage').title('All Pages')),
            ]),
      }),
      visionTool(),
    ],
