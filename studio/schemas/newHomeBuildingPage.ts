...
export default defineType({
    name: 'newHomeBuildingPage',
    title: 'New Home Building Use Case',
    type: 'document',
    groups: [
    ...
    fields: [
        ...
        defineField({
            ...
            type: 'string',
            hidden: true,
            initialValue: 'New Home Building Page'
        }),
        // SEO
        ...
        defineField({ name: 'caseStudyIcon', title: 'Case Study Icon (Lucide name)', type: 'string', description: 'e.g. Home, Layout, Ruler', group: 'caseStudy' }),
    ...
    preview: {
        ...
        prepare({ title }) {
            return {
                title: title || 'New Home Building Page'
            };
        }
    }
});
