...
export default defineType({
    name: 'vastuOptimizationPage',
    title: 'Vastu Optimization Use Case',
    type: 'document',
    groups: [
    ...
    fields: [
        ...
        defineField({
            ...
            type: 'string',
            hidden: true,
            initialValue: 'Vastu Optimization Page'
        }),
        // SEO
        ...
        defineField({ name: 'caseStudyIcon', title: 'Case Study Icon (Lucide name)', type: 'string', description: 'e.g. Ruler, Home, Sparkles', group: 'caseStudy' }),
    ...
    preview: {
        ...
        prepare({ title }) {
            return {
                title: title || 'Vastu Optimization Page'
            };
        }
    }
});
