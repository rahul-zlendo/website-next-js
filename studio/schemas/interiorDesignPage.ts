...
export default defineType({
    ...
    fields: [
        defineField({
            ...
            type: 'string',
            hidden: true,
            initialValue: 'Interior Design Page'
        }),
        ...
        // Primary Case Study (Matching Home Remodeling Structure)
        ...
        defineField({ name: 'caseStudyIcon', title: 'Case Study Icon (Lucide name)', type: 'string', description: 'e.g. Layout, Home, Sparkles', group: 'caseStudy' }),
        ...
        // Additional Case Studies (Optional array for second case study)
        defineField({
    ...
    preview: {
        ...
        prepare({ title }) {
            return { title: title || 'Interior Design Page' };
        }
    }
});
