            ...
            <section className="relative overflow-hidden py-12 lg:py-20">
                ...
                <div className="container-custom px-6 lg:px-12 relative z-10">
                    <div className="max-w-4xl mx-auto text-center">
                        <motion.div {...fadeUp} className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white border border-zlendo-teal/10 shadow-sm mb-8">
                        ...
                        <motion.p {...fadeUp} transition={{ delay: 0.2 }} className="text-lg md:text-xl text-zlendo-grey-medium font-medium leading-relaxed max-w-3xl mx-auto mb-4">
                        ...
                        <motion.p {...fadeUp} transition={{ delay: 0.25 }} className="text-base md:text-lg text-zlendo-grey-medium/80 font-medium max-w-2xl mx-auto mb-10">
                        ...
                        <motion.div {...fadeUp} transition={{ delay: 0.3 }} className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
                            <Link href={getPath('/services/floor-plan-design/consultation')} className="btn-primary py-4 px-10 text-lg rounded-2xl text-center inline-flex items-center justify-center gap-2">
                                Book Free Floor Plan Consultation <ArrowRight className="w-5 h-5" />
                            </Link>
                            <Link href={getPath('/services/floor-plan-design/consultation')} className="btn-orange py-4 px-10 text-lg rounded-2xl text-center">
                                Upload Your Plot Details
                            </Link>
                        </motion.div>
                        <motion.div {...fadeUp} transition={{ delay: 0.4 }} className="flex flex-wrap justify-center gap-4 lg:gap-6">
                            {trustHighlights.map((item, i) => (
                                <div key={i} className="flex items-center gap-2.5 px-4 py-2.5 rounded-2xl bg-white border border-black/[0.04] shadow-sm">
                                    <item.icon className="w-4 h-4 text-zlendo-teal shrink-0" />
                                    <span className="text-sm font-bold text-zlendo-grey-dark whitespace-nowrap">{item.label}</span>
                                </div>
                            ))}
                        </motion.div>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                        ...
                        >
                            <div className="relative rounded-[32px] overflow-hidden shadow-2xl border-4 border-white ring-1 ring-black/5 group">
                                <img
                                    src="/assets/global/luxury-blueprint.webp"
                                    alt="Professional 2D Floor Plan Design"
