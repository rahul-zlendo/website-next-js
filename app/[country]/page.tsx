    ...
    <div className="bg-white font-nunito selection:bg-zlendo-teal/10">
      ...
      <main className="pt-4 md:pt-6">
        ...
        <section className="container-custom text-center mb-2 md:mb-3 px-4 overflow-visible relative">
          ...
          >
            {/* Design your <span className="text-zlendo-teal italic">Dream Home</span> <br />
                        before you build it. */}
          ...
          >
            {/* Convert 2D plans into immersive walkthroughs, choose materials, and know your budget — all in minutes. */}
