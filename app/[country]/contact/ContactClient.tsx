                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-20">
                    ...
                    <div className="lg:col-span-5 space-y-16">
                        <div className="space-y-8">
                            <h2 className="text-3xl font-black text-zlendo-grey-dark">
                                {cms?.directContactTitle || "Get in touch directly"}
                            </h2>
                            <p className="text-lg text-zlendo-grey-medium font-bold opacity-60">
                                {cms?.directContactSubtitle || "Prefer a direct conversation? Reach out to our dedicated teams across India."}
                            </p>
                        ...
                        <div className="space-y-8 border-t border-black/[0.05] pt-12">
                            <div className="flex gap-4">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        <h4 className="text-[12px] font-black uppercase tracking-widest text-zlendo-teal mb-3">
                                            {cms?.hqTitle || "Headquarters"}
                                        </h4>
                                        <p className="text-xl font-bold text-zlendo-grey-dark leading-relaxed whitespace-pre-line">
                                            {cms?.hqAddress || "36/1, Ganapathy Street,\nAlagappan Nagar, Madurai – 625003\nTamil Nadu, India"}
                                        </p>
                                    </div>
                                    <div>
                                        <h4 className="text-[12px] font-black uppercase tracking-widest text-zlendo-grey-medium opacity-40 mb-3">
                                            {cms?.regionalPresenceLabel || "Regional Presence"}
                                        </h4>
                        ...
                        <div className="bg-white rounded-[40px] p-8 md:p-12 shadow-2xl shadow-black/[0.03] border border-black/[0.03] relative overflow-hidden">
                            <AnimatePresence>
                                {isSubmitted ? (
                                    ...
                                    >
                                        ...
                                        <h3 className="text-3xl font-black text-zlendo-grey-dark mb-4">
                                            {cms?.formSuccessTitle || "Message Sent!"}
                                        </h3>
                                        <p className="text-xl text-zlendo-grey-medium font-bold opacity-60 mb-8 max-w-sm">
                                            {cms?.formSuccessMessage || "Thanks for reaching out. A Zlendo Realty expert will get back to you within 24 hours."}
                                        </p>
                                        <button
                                            onClick={() => {
                                                dispatch(resetContactForm());
                            ...
                            <form onSubmit={handleSubmit} autoComplete="off" className="space-y-8">
                                <div className="space-y-4">
                                    <h3 className="text-2xl font-black text-zlendo-grey-dark">
                                        {cms?.formTitle || "Send us a message"}
                                    </h3>
            ...
            <section className="py-24 bg-[#f9fafb]">
                <div className="container-custom px-6 lg:px-12">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-black text-zlendo-grey-dark mb-4">
