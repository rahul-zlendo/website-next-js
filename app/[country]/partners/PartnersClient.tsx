...
const IconMap: Record<string, any> = {
    Handshake, TrendingUp, Coins, Layout, MessageSquare, Share2, Building2, CheckCircle2,
    ArrowRight, Wallet, LineChart, Smartphone, FileText, Zap, Download, Award, Briefcase, Globe, Home
};
const getIcon = (name: string, FallbackIcon: any) => IconMap[name] || FallbackIcon;

interface PartnersClientProps {
    cms: any;
    resolvedAffiliateSteps: any[];
    resolvedAffiliateBenefits: any[];
    resolvedPartnerFeatures: any[];
    resolvedWhyCards: any[];
    resolvedGrowthPoints: any[];
}

export default function PartnersClient({
    cms,
    resolvedAffiliateSteps,
    resolvedAffiliateBenefits,
    resolvedPartnerFeatures,
    resolvedWhyCards,
    ...
    return (
        <div className="bg-white selection:bg-zlendo-teal/10 selection:text-zlendo-teal overflow-x-hidden pt-5">
            {/* 1. HERO SECTION */}
                    ...
                    <div className="max-w-5xl mx-auto text-center">
                        ...
                        >
                            ...
                            <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.2em]">
                                {cms?.heroSubtitle || "The Future of PropTech is Collaborative"}
                            </span>
                        </motion.div>
                        ...
                        >
                            {cms?.heroTitlePart1 || "Share. Earn."}
                            <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-zlendo-teal to-blue-600 italic">
                                {cms?.heroTitlePart2 || "Grow with Zlendo Realty."}
                            </span>
                        </motion.h1>
                        ...
                        >
                            {cms?.heroDesc || "Turn your network into revenue. Help others design, visualize, and sell better — while you build a sustainable income stream."}
                        </motion.p>
                                    ...
                                    <div className="bg-white rounded-[50px] p-8 md:p-16 border border-black/5 shadow-2xl relative overflow-hidden">
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                                            <div className="space-y-8">
                                                ...
                                                <h3 className="text-4xl md:text-5xl font-black font-nunito text-zlendo-grey-dark leading-tight">
                                                    {cms?.affiliateTitlePart1 || "Earn by sharing"}{" "}
                                                    <span className="text-zlendo-teal italic">
                                                        {cms?.affiliateTitlePart2 || "the future."}
                                                    </span>
                                                </h3>
                                                <p className="text-xl text-zlendo-grey-medium font-medium leading-relaxed">
                                                    {cms?.affiliateDesc || "Best for creators, influencers, consultants, and marketers who want to monetize their network through simple referrals."}
                                                </p>

                                                <div className="space-y-6">
                                                    <h4 className="text-sm font-black uppercase tracking-widest text-zlendo-grey-medium opacity-40">How it works</h4>
                                                    <div className="grid gap-6">
                                                        {resolvedAffiliateSteps.map((item, i) => {
                                                            const Icon = getIcon(item.icon, Wallet);
                                                            return (
                                            ...
                                            <div className="space-y-10">
                                                <div className="bg-slate-50 rounded-[40px] p-8 md:p-12 border border-black/5 shadow-inner">
                                                    ...
                                                    <div className="grid gap-4">
                                                        {resolvedAffiliateBenefits.map((benefit, i) => {
                                                            const Icon = getIcon(benefit.icon, TrendingUp);
                                                            return (
                                                ...
                                                <div className="text-center bg-zlendo-teal/5 p-8 rounded-[40px] border border-zlendo-teal/10">
                                                    ...
                                                    <div className="flex flex-wrap justify-center gap-3">
                                                        {(cms?.affiliateTags || ['Influencers', 'Bloggers', 'Property Reviewers', 'Startup Leaders', 'Design Enthusiasts']).map((tag: string) => (
                                        ...
                                        <div className="mt-16 pt-12 border-t border-black/5 flex flex-col md:flex-row items-center justify-between gap-8">
                                            <div className="text-left">
                                                <div className="text-2xl font-black font-nunito text-zlendo-grey-dark">{cms?.affiliateConversionRate || "4.2%"}</div>
                                            ...
                                            <div className="text-right">
                                                <div className="text-2xl font-black font-nunito text-zlendo-grey-dark">{cms?.affiliateAvgEarnings || "₹45k+"}</div>
                                        ...
                                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                                            <div className="space-y-8">
                                                ...
                                                <h3 className="text-4xl md:text-5xl font-black font-nunito text-white leading-tight">
                                                    {cms?.partnerTitlePart1 || "Go beyond referrals."}
                                                    <br />
                                                    <span className="text-blue-400 italic">
                                                        {cms?.partnerTitlePart2 || "Build recurring revenue."}
                                                    </span>
                                                </h3>
                                                <p className="text-xl text-white/60 font-medium leading-relaxed">
                                                    {cms?.partnerDesc || "Best for agencies, interior designers, architects, and real estate consultants who want to build a business with Zlendo."}
                                                </p>

                                                <div className="grid sm:grid-cols-2 gap-6">
                                                    {resolvedPartnerFeatures.map((item, i) => {
                                                        const Icon = getIcon(item.icon, Building2);
                                                        return (
                                            ...
                                            <div className="relative">
                                                ...
                                                <div className="relative rounded-[40px] overflow-hidden border border-white/10 shadow-2xl bg-black aspect-square">
                                                    ...
                                                    <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black via-black/20 to-transparent p-10">
                                                        <div className="text-sm font-black text-blue-400 uppercase tracking-widest mb-2">
                                                            {cms?.partnerUseCaseTitle || "Use Case"}
                                                        </div>
                                                        <div className="text-xl font-bold leading-tight">
                                                            {cms?.partnerUseCaseDesc || "Design studios bundling Zlendo walkthroughs with premium interior packages."}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="mt-16 pt-12 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-8">
                                            <div className="flex gap-4">
                                                <div className="text-center px-6">
                                                    <div className="text-2xl font-black font-nunito text-white">{cms?.partnerActivePartners || "500+"}</div>
                                                ...
                                                <div className="text-center px-6 border-x border-white/10">
                                                    <div className="text-2xl font-black font-nunito text-white">{cms?.partnerPayouts || "₹15Cr+"}</div>
            ...
            <section className="py-20 relative overflow-hidden">
                <div className="container-custom px-4 text-center">
                    <div className="max-w-4xl mx-auto mb-12 space-y-4">
                        <h2 className="text-4xl md:text-5xl font-black font-nunito text-zlendo-grey-dark">{cms?.whyTitle || "Why Take Zlendo Realty to Your Network?"}{country === 'in' && <span className="sr-only"> (India)</span>}</h2>
                    ...
                    <div className="max-w-4xl mx-auto space-y-10">
                        ...
                        >
                            ...
                            <div className="grid md:grid-cols-2 gap-10 text-left pt-8 border-t border-black/5">
                                {resolvedGrowthPoints.map((point, i) => {
                                    const Icon = getIcon(point.icon, Award);
                                    return (
                    ...
                    <div className="max-w-4xl mx-auto space-y-12">
                        <div className="space-y-4">
                            <h2 className="text-4xl md:text-5xl font-black font-nunito leading-tight text-zlendo-grey-dark">
                                {cms?.finalCtaTitlePart1 || "Turn Influence Into"}{" "}
                                <span className="text-zlendo-teal italic">
                                    {cms?.finalCtaTitlePart2 || "Income."}
                                </span>
                            ...
                            <p className="text-xl text-zlendo-grey-medium font-medium leading-relaxed max-w-2xl mx-auto opacity-60">
                                {cms?.finalCtaSubtitle || "Start today. Grow with India’s most innovative home tech platform."}
                            </p>
                        </div>
