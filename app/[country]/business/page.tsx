                                            ...
                                            <div className="space-y-1.5 sm:space-y-2">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <div className="absolute right-3 sm:right-5 top-1/2 -translate-y-1/2 pointer-events-none opacity-50">
                                                        <svg className="w-3 h-2 sm:w-3 sm:h-2" width="12" height="8" viewBox="0 0 12 8" fill="none" ><path d="M1 1.5L6 6.5L11 1.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                                                    </div>
                                                </div>
                                            </div>
