...
const COMPARISON_PAGES: { title: string; url: string; desc: string }[] = [
  ...
  { title: 'Zlendo Realty vs RoomSketcher', url: `${BASE}/compare/zlendo-vs-roomsketcher`, desc: 'Zlendo Realty compared to RoomSketcher for floor plans and visualization.' },
