...
import FloorPlanDesignClient from '@/app/[country]/services/floor-plan-design/FloorPlanDesignClient';
...
export async function generateMetadata(): Promise<Metadata> {
    return createPageMetadata({
        ...
        path: '/services/floor-plan-design',
    });
}

export default async function FloorPlanDesignPage() {
    const faqSchema = {
