...
export default function DesignPresentationClient() {
                            ...
                            <div className="lg:col-span-4 space-y-4">
                                {challenges.map((item, i) => (
                                    <button
                                        ...
                                        className={`w-full text-left p-6 rounded-2xl transition-all duration-300 flex items-center gap-4 group ${activeTab === i
                                                ? 'bg-white/10 shadow-[inset_4px_0_0_#FCD884]'
                                                : 'hover:bg-white/5 opacity-60 hover:opacity-100'
                                            }`}
                                    >
                                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-colors ${activeTab === i ? 'bg-[#FCD884] text-[#715000]' : 'bg-white/5 text-white'
                                            }`}>
