...
export const COMPARE_INDEX: CompareIndexGroup[] = [
  {
    ...
    entries: [
      { slug: 'zlendo-vs-coohom', title: 'Zlendo Realty vs Coohom', blurb: 'Data privacy, vastu, and INR pricing vs a massive furniture catalog.' },
      { slug: 'zlendo-vs-foyr-neo', title: 'Zlendo Realty vs Foyr Neo', blurb: 'India pricing, vastu, and AI automation vs mood boards and material libraries.' },
      { slug: 'zlendo-vs-maket', title: 'Zlendo Realty vs Maket', blurb: 'A complete design-to-client workflow vs pure generative 2D floor plans.' },
      { slug: 'zlendo-vs-snaptrude', title: 'Zlendo Realty vs Snaptrude', blurb: 'AI design-to-client with vastu and renders vs collaborative BIM for architects.' },
      { slug: 'zlendo-vs-planner5d', title: 'Zlendo Realty vs Planner 5D', blurb: 'Professional-grade 8K output vs a consumer DIY design app.' },
      { slug: 'zlendo-vs-sketchup', title: 'Zlendo Realty vs SketchUp', blurb: 'Instant AI spatial design vs manual 3D modelling with paid render plugins.' },
      { slug: 'zlendo-vs-roomsketcher', title: 'Zlendo Realty vs RoomSketcher', blurb: 'AI automation and India features vs a simple, pre-AI floor plan tool.' },
    ],
  },
  {
