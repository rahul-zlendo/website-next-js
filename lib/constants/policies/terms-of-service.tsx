...
export const termsOfServiceSections: PolicySection[] = [
    ...
    },
    {
        ...
        content: (
            <div className="font-nunito text-lg text-zlendo-grey-medium leading-relaxed text-justify space-y-4">
                <p>Zlendo Realty provides AI-powered tools for real estate design, converting 2D plans to 3D, creating virtual reality walkthroughs (VR Studio), offering Vaastu recommendations, cost estimation (BoQ), and API integrations.</p>
