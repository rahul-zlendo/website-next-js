...
const routes = [
  ...
  { path: '/products/kids-room-layouts', priority: 0.9, changeFrequency: 'weekly' as const, isGlobal: true },
  { path: '/products/bathroom-design-tool', priority: 0.9, changeFrequency: 'weekly' as const, isGlobal: true },
  ...
  { path: '/products/smart-wizard', priority: 0.9, changeFrequency: 'weekly' as const },
