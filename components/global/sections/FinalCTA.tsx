...
const FinalCTA: React.FC<FinalCTAProps> = ({ data }) => {
  ...
  return (
    <section className="py-24 md:py-32 bg-[#0A0A0A] text-white font-nunito overflow-hidden relative">
      {/* Dynamic Background */}
      ...
      <div className="container-custom px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* CTA Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20 lg:mb-24">
            {/* Primary */}
            <motion.div 
              ...
              className="group"
            >
              <Link href={primaryCta?.link || '#'} className="flex flex-col items-center justify-center h-full p-8 rounded-[40px] bg-zlendo-teal text-white hover:bg-[#008f72] transition-all transform hover:scale-[1.02] shadow-2xl shadow-zlendo-teal/20 text-center">
            ...
            <motion.div 
              ...
              className="group"
            >
              <Link href={secondaryCta?.link || '#'} className="flex flex-col items-center justify-center h-full p-8 rounded-[40px] bg-white/5 border border-white/10 hover:bg-white/10 transition-all transform hover:scale-[1.02] text-center">
            ...
            <motion.div 
              ...
              className="group"
            >
              <Link href={tertiaryCta?.link || '#'} className="flex flex-col items-center justify-center h-full p-8 rounded-[40px] bg-white/5 border border-white/10 hover:bg-white/10 transition-all transform hover:scale-[1.02] text-center">
