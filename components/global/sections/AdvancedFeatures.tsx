                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {[
                        ...
                        },
                        {
                            ...
                            bg: "bg-orange-50",
                            img: "https://images.unsplash.com/photo-1542889601-399c4f3a8402?auto=format&fit=crop&q=80&w=600"
                        },
                        {
                            ...
                            color: "text-pink-500",
                            bg: "bg-pink-50",
                            img: "https://images.unsplash.com/photo-1616486029423-aaa4789e8c9a?auto=format&fit=crop&q=80&w=600"
                        },
                        {
                            ...
                            bg: "bg-indigo-50",
                            img: "https://images.unsplash.com/photo-1493723843671-1d655e66ac1c?auto=format&fit=crop&q=80&w=600"
                        }
                    ].map((feature, i) => (
                        <motion.div 
                            key={i}
